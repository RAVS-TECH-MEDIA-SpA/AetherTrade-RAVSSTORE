...
export default function TrustSection({ countryCode }: TrustSectionProps) {
  ...
  return (
    <section className="container mx-auto px-6 py-12">
      ...
      <div className="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto snap-x snap-mandatory scroll-smooth [&::-webkit-scrollbar]:hidden pb-4 md:pb-0">
        
        <div className="snap-center shrink-0 w-[85%] sm:w-[45%] md:w-auto bg-slate-900/40 border border-slate-800/50 p-8 rounded-3xl backdrop-blur-sm group hover:border-violet-500/50 transition-colors">
        ...
        <div className="snap-center shrink-0 w-[85%] sm:w-[45%] md:w-auto bg-slate-900/40 border border-slate-800/50 p-8 rounded-3xl backdrop-blur-sm group hover:border-violet-500/50 transition-colors text-violet-400 shadow-2xl shadow-violet-500/5">
