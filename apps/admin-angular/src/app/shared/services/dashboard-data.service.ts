...
export class DashboardDataService {
  private apiUrl = '/api'; // Ajusta según tu configuración de proxy o entorno
  ...
  getSummary(): Observable<SummaryResponse> {
    return this.http.get<SummaryResponse>(`${this.apiUrl}/stats/summary`);
  }
  ...
  getInventory(): Observable<WinningProduct[]> {
    return this.http.get<WinningProduct[]>(`${this.apiUrl}/inventory`);
  }
